...
if __name__=='__main__':
    #alice_seed=server()
    seed=b')G$\xa6>\x0f\xda\x8cs\x1d\x96\x12\xb0\xa8\xe8\xb9\xbc\x0e\xc0\x87\xca\x99 \xc8H\x8c]\xd1\xdf\x94\xeb\xff'
    seed=long_to_bytes(bytes_to_long(seed)-2,32)
    alice=DiffieHellman(seed)
    assert not alice.my_secret
    ...
    cipher = AES.new(long_to_bytes(1337^1, 16)[:16], AES.MODE_CBC, IV=iv)
